...
$options = array(
    'main' => array(
        'type' => 'box',
        'title' => __('Дополнительные настройки категории', '{domain}'),
        'options' => array(
            'kdv_category_bg_img' => array(
                'type'  => 'upload',
                'value' => array(
                    /*
                    'attachment_id' => '9',
                ...
                'desc'  => __('', '{domain}'),
                'help'  => __('Загрузите фоновое изображение категории (разрешенные файлы для загрузки: jpg, png, gif)', '{domain}'),
                /**
